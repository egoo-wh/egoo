...
function isRelativePath(p) {
	return !/^((http(s)?|ftp|):)?\/\//i.test(p) && !/^(data:image)/i.test(p) && !path.isAbsolute(p);
}
...
module.exports = {log, serverPathJoin, sfcall, showPrompt, bytesSizeFormat, getConfigURL, isRelativePath, isHttpPath};